    ...
    public void save(int sampleId, String content) {
        ...
        DBUtils.execSQL(connection -> {
            ...
            try {
                ...
                // 数据库字段顺序（不含 sample_id，最后含 Otherinfo）
                List<String> dbFields = Arrays.asList(
                        ...
                        "cosmic70", "ICGC_Id", "ICGC_Occurrence",
                        "InterVar_automated",
                ...
                for (int i = 1; i < lines.length; i++) {
                    ...
                    for (int j = 0; j < dbFields.size(); j++) {
                        ...
                        preparedStatement.setString(j + 2, getValue(split, headerIndex, fieldName));
                    }

                    // 收集不在数据库固定字段中的列，拼到 Otherinfo
